  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      ...
      <motion.div variants={item} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 card p-6 relative overflow-hidden flex flex-col justify-between min-h-[220px]" style={{ background: "linear-gradient(to bottom right, var(--color-accent-light), white)", borderColor: "var(--color-accent-light)" }}>
          <div>
            <h3 className="type-heading-md font-bold" style={{ color: "var(--color-accent-dark)" }}>Your SurveyHub Experience</h3>
          ...
          <div className="flex items-center gap-4 mt-6">
            <Link to="/dashboard/participation" className="btn btn-primary btn-sm font-semibold">
