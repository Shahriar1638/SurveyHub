  ...
  return (
    <div className="h-screen w-full overflow-hidden bg-bg-base">
      <div className="grid h-screen w-full grid-cols-1 md:grid-cols-[1.1fr_1fr] lg:grid-cols-[1.25fr_1fr] xl:grid-cols-[1.35fr_1fr]">
        ...
        <main className="order-1 relative flex h-screen min-h-0 items-start justify-center overflow-y-auto bg-gradient-to-br from-bg-surface via-bg-base to-visitor-light/10 px-6 py-8 sm:px-10 sm:py-12 md:order-2 md:col-start-2 lg:order-2">
          ...
          <motion.div 
            ...
            initial="hidden"
            animate="visible"
            className="relative z-10 w-full max-w-md py-8 px-6 sm:px-8 bg-bg-surface border border-border rounded-2xl shadow-xl overflow-hidden mt-8 sm:mt-0"
          >
